	...
	<div class="wrap about__container">
		...
		<div class="about__section has-2-columns">
			<div class="column is-vertically-aligned-center">
				...
				<p><?php _e( 'A new sidebar experience makes it easier to edit your site&#8217;s navigation. Add, remove, and reorder menu items fasterΓÇöno matter how complex your menus are.' ); ?></p>
			</div>
			<div class="column">
				<div class="about__image">
		...
		<div class="about__section has-2-columns">
			...
			<div class="column">
				...
				<p><?php _e( 'Openverse&#8217;s library catalogs over 600 million free, openly licensed stock images and audioΓÇöand now it&#8217;s directly integrated into the Editor.' ); ?></p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns">
			...
			<div class="column">
				...
				<p><?php _e( 'Stable and ready for you to dive in and explore: 6.2 is your personal invitation to discover what the next generation of WordPressΓÇöand Block themesΓÇöcan do.' ); ?></p>
			</div>
		</div>
