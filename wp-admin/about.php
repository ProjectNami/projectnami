	...
	<div class="wrap about-wrap full-width-layout">
		...
		<div class="feature-section is-wide has-2-columns is-wider-right">
			...
			<div class="column is-vertically-aligned-center">
				...
				<p><?php _e( 'This administrator-focused update will let you safely fix or manage fatal errors without requiring developer time. It features better handling of the so-called ΓÇ£white screen of death,ΓÇ¥ and a way to enter recovery mode,  which pauses error-causing plugins or themes.' ); ?></p>
			</div>
		</div>
