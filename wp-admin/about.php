	...
	<div class="wrap about__container">
		...
		<div class="about__header">
			...
			<div class="about__header-text">
				<?php _e( 'Jazz up your stories in an editor thatΓÇÖs cleaner, crisper, and does more to get out of your way.' ); ?>
			</div>
		...
		<div class="about__section is-feature has-subtle-background-color">
			<div class="column">
				...
				<p>
					<?php
					_e( 'With this new version, WordPress brings you fresh colors. The editor helps you work in a few places you couldnΓÇÖt beforeΓÇöat least, not without getting into code or hiring a pro. The controls you use most, like changing font sizes, are in more placesΓÇöright where you need them. And layout changes that should be simple, like full-height images, are even simpler to make.' );
					?>
				</p>
			</div>
		</div>
			...
			<div class="column">
				...
				<p>
					...
					printf(
						...
						__( 'Find the new palette in the default WordPress Dashboard color scheme, and use it when youΓÇÖre building themes, plugins, or any other components. For all the details, <a href="%s">check out the Color Palette dev note</a>.' ),
		...
		<div class="about__section has-2-columns">
			...
			<div class="column">
				...
				<p><?php _e( 'For years jQuery helped make things move on the screen in ways the basic tools couldnΓÇÖtΓÇöbut that keeps changing, and so does jQuery.' ); ?></p>
				...
				<p><?php _e( 'Now itΓÇÖs simple to let iframes lazy-load. By default, WordPress will add a <code>loading="lazy"</code> attribute to iframe tags when both width and height are specified.' ); ?></p>
			</div>
		</div>
