...
?>
	<div class="wrap about-wrap full-width-layout">
		...
		<div class="feature-section one-col">
			<div class="col">
				<p><?php _e( 'You&#8217;ve successfully upgraded to WordPress 5.0! WeΓÇÖve made some big changes to the editor. Our new block-based editor is the first step toward an exciting new future with a streamlined editing experience across your site. YouΓÇÖll have more flexibility with how content is displayed, whether you are building your first site, revamping your blog, or write code for a living.' ); ?></p>
			</div>
		</div>
		...
		<div class="feature-section three-col">
			...
			<div class="col">
				...
				<p><?php _e( 'Twenty Nineteen is designed to work for a wide variety of use cases. Whether youΓÇÖre running a photo blog, launching a new business, or supporting a non-profit, Twenty Nineteen is flexible enough to fit your needs.' ); ?></p>
			</div>
		</div>
