	...
	<div class="wrap about__container">
		...
		<div class="about__section has-2-columns">
			...
			<div class="column">
				...
				<ul>
					...
					<li><?php _e( 'Keep existing styles when you transform some blocks from one kind to anotherΓÇöfrom a Paragraph block to a Code block, for instance.' ); ?></li>
		...
		<div class="about__section has-3-columns">
			...
			<div class="column">
				...
				<p><?php _e( 'Use the gap support functionality in the Gallery block to create different looksΓÇôfrom adding spacing between all images, to removing spacing altogether.' ); ?></p>
			</div>
		</div>
