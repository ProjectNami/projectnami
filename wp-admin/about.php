	...
	<div class="wrap about__container">
		...
		<div class="about__section has-1-column">
			<div class="column">
				...
				<p><?php _e( 'In WordPress 5.5, images wait to load until theyΓÇÖre just about to scroll into view. The technical term is ΓÇÿlazy loading.ΓÇÖ' ); ?></p>
				<p><?php _e( 'On mobile, lazy loading can also keep browsers from loading files meant for other devices. That can save your readers money on data ΓÇö and help preserve battery life.' ); ?></p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns has-accent-background-color is-wider-right">
			<div class="column">
				...
				<p><?php _e( 'Now you can set plugins and themes to update automatically ΓÇö or not! ΓÇö in the WordPress admin. So you always know your site is running the latest code available.' ); ?></p>
				<p><?php _e( 'You can also turn auto-updates on or off for each plugin or theme you have installed ΓÇö all on the same screens youΓÇÖve always used.' ); ?></p>
				<p><strong><?php _e( 'Update by uploading ZIP files' ); ?></strong></p>
				<p><?php _e( 'If updating plugins and themes manually is your thing, now thatΓÇÖs easier too ΓÇö just upload a ZIP file.' ); ?></p>
			</div>
		...
		<div class="about__section has-2-columns has-subtle-background-color">
			...
			<div class="column">
				...
				<p><?php _e( 'You will also find block patterns in a wide variety of plugins and themes, with more added all the time. Pick any of them from a single place ΓÇö just click and go!' ); ?></p>
				...
				<p><?php _e( 'Now itΓÇÖs easier than ever to find the block you need. The new block directory is built right into the block editor, so you can install new block types to your site without ever leaving the editor.' ); ?></p>

				<h3><?php _e( 'And so much more.' ); ?></h3>
				<p><?php _e( 'The highlights above are a tiny fraction of the new block editor features youΓÇÖve just installed. Open the block editor and enjoy!' ); ?></p>
			</div>
		</div>
			...
			<div class="column">
				...
				<p>
					...
					printf(
						...
						__( 'WordPress now has a standardized way to define a siteΓÇÖs environment type (staging, production, etc). Retrieve that type with %s and execute only the appropriate code.' ),
			...
			<div class="column">
				...
				<p>
					...
					printf(
						...
						__( 'The template loading functions (%1$s, %2$s, etc.) have a new %3$s argument. So now you can pass an entire arrayΓÇÖs worth of data to those templates.' ),
				...
				<ul>
					...
					<li>
						...
						printf(
							...
							__( 'Sites that use PHPΓÇÖs OPcache will see more reliable cache invalidation, thanks to the new %s function during updates (including to plugins and themes).' ),
			...
			<div class="column">
				...
				<p>
					...
					printf(
						...
						__( 'ThereΓÇÖs a lot more for developers to love in WordPress 5.5. To discover more and learn how to make these changes shine on your sites, themes, plugins and more, check the <a href="%s">WordPress 5.5 Field Guide.</a>' ),
