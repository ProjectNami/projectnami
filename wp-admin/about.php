			...
			<div class="column is-vertically-aligned-center">
				...
				<p>
					...
					printf(
						...
						__( '<a href="%s">New fallback options</a> in the navigation block mean you can edit the menu thatΓÇÖs open; no searching needed. Plus, the controls for choosing and working on menus have their own place in the block settings. The mobile menu system also gets an upgrade with new features, including different icon options, to make the menu yours.' ),
			...
			<div class="column">
				...
				<p>
					...
					printf(
						...
						__( '<a href="%s">Leverage filters</a> in the Styles sidebar to control settings at all four levels of your siteΓÇöcore, theme, user, or block, from less to more specific.' ),
