...
class WP_Upgrader {
	...
	public static function create_lock( $lock_name, $release_timeout = null ) {
		...
		// Try to lock.
		$lock_result = $wpdb->query( $wpdb->prepare( "IF NOT EXISTS (SELECT * FROM [$wpdb->options] WHERE [option_name] = '%s') INSERT [$wpdb->options] ( [option_name], [option_value], [autoload] ) VALUES (%s, %s, 'off') /* LOCK */", $lock_option, $lock_option, time() ) );
