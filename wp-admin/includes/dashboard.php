...
function wp_dashboard_php_nag() {
	...
	<p><?php _e( 'PHP is the programming language we use to build and maintain WordPress. Newer versions of PHP are both faster and more secure, so updating will have a positive effect on your siteΓÇÖs performance.' ); ?></p>
