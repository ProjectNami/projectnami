...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table">
		...
		<tr>
			...
			<td><?php _e( 'Your MSSQL username. <span style="font-weight: bold; font-size: 12px; display: block;">Note: If using SQL Azure, username is of the form username@databasename.</span>' ); ?></td>
		</tr>
		<tr>
